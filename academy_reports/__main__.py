...
from report_tasks.S4 import daily_report_S4
from report_tasks.water_calibration import report_water_calibration
from report_tasks.intersession import report_intersession
        ...
        for path in raw_paths:
            ...
            if len(subject) <= 10:
                ...
                try:
                    ...
                    report_intersession(df.copy(), save_path_intersession)
                ...
                for sess, session in df.groupby('session'):
                    ...
                    if not os.path.exists(save_path): #ONLY DONE IF NOT EXISTS
                        ...
                        # elif task == 'S4':
                        #     daily_report_S4(session.copy(), save_path, date)
                        # else:
                        #     print('Task not found for file:', path, 'task:', task)
                        ...
                        if task == 'S4':
                            ...
                            print('Task not found for file:', file_name)
